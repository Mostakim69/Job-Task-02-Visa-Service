const Testimonials = () => {
    const cardsData = [
        {
            ...
            handle: '@mostakim35',
            date: 'July 20, 2025',
            testimonial: 'Visa Navigator streamlined my visa application process flawlessly. Clear guidelines, accurate processing times, and real-time updates made planning seamless. Truly a reliable companion for international travel.'
        },
        {
            ...
            date: 'June 10, 2025',
            testimonial: 'Using Visa Navigator was an absolute delight. The platform offers comprehensive visa information, step-by-step guidance, and user-friendly navigation. Stress-free visa management at its best.'
        },
        {
            ...
            testimonial: 'Visa Navigator combines professionalism with efficiency. Its accurate visa information, clear application steps, and tracking features make it highly dependable. I highly recommend it for anyone needing visa assistance.'
        },
        {
            ...
            handle: '@sohana_mow',
            date: 'July 15, 2025',
            testimonial: 'The intuitive interface of Visa Navigator simplified what used to be a complicated process. Accurate information, helpful resources, and clear steps make it a must-have tool for travelers.'
        },
    ];
    ...
    return (
        <>
            ...
            <section className="py-12 bg-[linear-gradient(to_right,#b7c5eb,#747e8f)] ">
